    ...
    return (
        <div className="mb-4">
            ...
            <div className="flex flex-col md:flex-row mb-4">
                ...
                <div className="bg-red-400 w-full md:w-1/2 p-4">Kolom 3</div>
                <div className="bg-blue-400 w-full md:w-1/2 p-4">Kolom 4</div>
                <div className="bg-red-400 w-full md:w-1/2 p-4">Kolom 5</div>
                <div className="bg-blue-400 w-full md:w-1/2 p-4">Kolom 6</div>
            </div>
        </div>
    )
}
