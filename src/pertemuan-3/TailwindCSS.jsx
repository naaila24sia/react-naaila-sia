export default function TailwindCSS() {
    return (
        <div className="space-y-6">
            <h1 class="shadow-lg bg-blue-100 p-2 m-4">Belajar Tailwind CSS 4</h1>
            <button className="bg-red-700 text-grey-300 px-4 py-2 mx-4 rounded shadow-lg">Click Me</button>
...
function BorderRadius(){
    return (
        <button className="border-2 border-blue-500 text-blue-500 ml-4 px-4 py-2 rounded-lg hover:shadow-md"> Klik Saya </button>
    )
}
